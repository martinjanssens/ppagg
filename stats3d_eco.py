...
if parseFlag:
    ...
    parser.add_argument("--loaddir", metavar="LOADDIR", type=str, default=".", help="Directory to load data from")
    parser.add_argument("--savedir", metavar="SAVEDIR", type=str, default=".", help="Directory to save data to")
...
for i in range(len(plttime)):
    ...
    if store:
        np.save(sp+'/time.npy',time[plttime])
        np.save(sp+'/plttime.npy',plttime)
        np.save(sp+'/zf.npy',zflim)
        
        np.save(sp+'/qtpf_moist_time.npy',qtpf_moist_time)
        np.save(sp+'/qtpf_dry_time.npy',qtpf_dry_time)
        np.save(sp+'/qtpf_prod_moist_time.npy',qtpf_prod_moist_time)
        np.save(sp+'/qtpf_prod_dry_time.npy',qtpf_prod_dry_time)
        np.save(sp+'/qtpf_prod_moist_wex_time.npy',qtpf_prod_moist_wex_time)
        np.save(sp+'/qtpf_prod_dry_wex_time.npy',qtpf_prod_dry_wex_time)
        np.save(sp+'/qtpf_vdiv_moist_time.npy',qtpf_vdiv_moist_time)
        np.save(sp+'/qtpf_vdiv_dry_time.npy',qtpf_vdiv_dry_time)
        np.save(sp+'/qtpf_hdiv_moist_time.npy',qtpf_hdiv_moist_time)
        np.save(sp+'/qtpf_hdiv_dry_time.npy',qtpf_hdiv_dry_time)
        np.save(sp+'/qtpf_subs_moist_time.npy',qtpf_subs_moist_time)
        np.save(sp+'/qtpf_subs_dry_time.npy',qtpf_subs_dry_time)
        np.save(sp+'/qtpf_diff_moist_time.npy',qtpf_diff_moist_time)
        np.save(sp+'/qtpf_diff_dry_time.npy',qtpf_diff_dry_time)
        np.save(sp+'/qtpf_micr_moist_time.npy',qtpf_micr_moist_time)
        np.save(sp+'/qtpf_micr_dry_time.npy',qtpf_micr_dry_time)
        
        np.save(sp+'/thlvpf_moist_time.npy',thlvpf_moist_time)
        np.save(sp+'/thlvpf_dry_time.npy',thlvpf_dry_time)
        np.save(sp+'/thlvpf_prod_moist_time.npy',thlvpf_prod_moist_time)
        np.save(sp+'/thlvpf_prod_dry_time.npy',thlvpf_prod_dry_time)
        np.save(sp+'/thlvpf_vdiv_moist_time.npy',thlvpf_vdiv_moist_time)
        np.save(sp+'/thlvpf_vdiv_dry_time.npy',thlvpf_vdiv_dry_time)
        np.save(sp+'/thlvpf_hdiv_moist_time.npy',thlvpf_hdiv_moist_time)
        np.save(sp+'/thlvpf_hdiv_dry_time.npy',thlvpf_hdiv_dry_time)
        np.save(sp+'/thlvpf_subs_moist_time.npy',thlvpf_subs_moist_time)
        np.save(sp+'/thlvpf_subs_dry_time.npy',thlvpf_subs_dry_time)
        np.save(sp+'/thlvpf_diff_moist_time.npy',thlvpf_diff_moist_time)
        np.save(sp+'/thlvpf_diff_dry_time.npy',thlvpf_diff_dry_time)
        np.save(sp+'/thlvpf_radi_moist_time.npy',thlvpf_radi_moist_time)
        np.save(sp+'/thlvpf_radi_dry_time.npy',thlvpf_radi_dry_time)
        np.save(sp+'/thlvpf_micr_moist_time.npy',thlvpf_micr_moist_time)
        np.save(sp+'/thlvpf_micr_dry_time.npy',thlvpf_micr_dry_time)
        
        np.save(sp+'/thlvpp_moist_time.npy',thlvpp_moist_time)
        np.save(sp+'/thlvpp_dry_time.npy',thlvpp_dry_time)
        np.save(sp+'/thlvpp_prod_moist_time.npy',thlvpp_prod_moist_time)
        np.save(sp+'/thlvpp_prod_dry_time.npy',thlvpp_prod_dry_time)
        np.save(sp+'/thlvpp_vdiv_moist_time.npy',thlvpp_vdiv_moist_time)
        np.save(sp+'/thlvpp_vdiv_dry_time.npy',thlvpp_vdiv_dry_time)
        np.save(sp+'/thlvpp_hdiv_moist_time.npy',thlvpp_hdiv_moist_time)
        np.save(sp+'/thlvpp_hdiv_dry_time.npy',thlvpp_hdiv_dry_time)
        np.save(sp+'/thlvpp_subs_moist_time.npy',thlvpp_subs_moist_time)
        np.save(sp+'/thlvpp_subs_dry_time.npy',thlvpp_subs_dry_time)
        np.save(sp+'/thlvpp_diff_moist_time.npy',thlvpp_diff_moist_time)
        np.save(sp+'/thlvpp_diff_dry_time.npy',thlvpp_diff_dry_time)
        
        np.save(sp+'/qlpf_moist_time.npy',qlpf_moist_time) 
        np.save(sp+'/qlpf_dry_time.npy',qlpf_dry_time)
        np.save(sp+'/qlpf_prod_moist_time.npy',qlpf_prod_moist_time)
        np.save(sp+'/qlpf_prod_dry_time.npy',qlpf_prod_dry_time)
        np.save(sp+'/qlpf_vdiv_moist_time.npy',qlpf_vdiv_moist_time)
        np.save(sp+'/qlpf_vdiv_dry_time.npy',qlpf_vdiv_dry_time)
        np.save(sp+'/qlpf_hdiv_moist_time.npy',qlpf_hdiv_moist_time)
        np.save(sp+'/qlpf_hdiv_dry_time.npy',qlpf_hdiv_dry_time)
        np.save(sp+'/qlpf_subs_moist_time.npy',qlpf_subs_moist_time)
        np.save(sp+'/qlpf_subs_dry_time.npy',qlpf_subs_dry_time)
        np.save(sp+'/qlpf_diff_moist_time.npy',qlpf_diff_moist_time)
        np.save(sp+'/qlpf_diff_dry_time.npy',qlpf_diff_dry_time)
        np.save(sp+'/qlpf_micr_moist_time.npy',qlpf_micr_moist_time)
        np.save(sp+'/qlpf_micr_dry_time.npy',qlpf_micr_dry_time)

        np.save(sp+'/wthlvpf_prod_moist_time',wthlvpf_prod_moist_time)
        np.save(sp+'/wthlvpf_prod_dry_time',wthlvpf_prod_dry_time)
        np.save(sp+'/wthlvpf_vdiv_moist_time',wthlvpf_vdiv_moist_time)
        np.save(sp+'/wthlvpf_vdiv_dry_time',wthlvpf_vdiv_dry_time)
        np.save(sp+'/wthlvpf_hdiv_moist_time',wthlvpf_hdiv_moist_time)
        np.save(sp+'/wthlvpf_hdiv_dry_time',wthlvpf_hdiv_dry_time)
        np.save(sp+'/wthlvpf_buoy_moist_time',wthlvpf_buoy_moist_time)
        np.save(sp+'/wthlvpf_buoy_dry_time',wthlvpf_buoy_dry_time)
        np.save(sp+'/wthlvpf_pres_moist_time',wthlvpf_pres_moist_time)
        np.save(sp+'/wthlvpf_pres_dry_time',wthlvpf_pres_dry_time)
        np.save(sp+'/wthlvpf_subs_moist_time',wthlvpf_subs_moist_time)
        np.save(sp+'/wthlvpf_subs_dry_time',wthlvpf_subs_dry_time)
        np.save(sp+'/wthlvpf_diff_moist_time',wthlvpf_diff_moist_time)
        np.save(sp+'/wthlvpf_diff_dry_time',wthlvpf_diff_dry_time)

        np.save(sp+'/thl_av_time.npy',thl_av_time)
        np.save(sp+'/thlv_av_time.npy',thlv_av_time)
        np.save(sp+'/qt_av_time.npy',qt_av_time)
        np.save(sp+'/qr_av_time.npy',qr_av_time)
        
        np.save(sp+'/thlpf_moist_time.npy',thlpf_moist_time)
        np.save(sp+'/thlpf_dry_time.npy',thlpf_dry_time)
        np.save(sp+'/wff_moist_time.npy',wff_moist_time)
        np.save(sp+'/wff_dry_time.npy',wff_dry_time)
        np.save(sp+'/qrpf_moist_time.npy',qrpf_moist_time)
        np.save(sp+'/qrpf_dry_time.npy',qrpf_dry_time)
        
        np.save(sp+'/thlpp_moist_time.npy',thlpp_moist_time)
        np.save(sp+'/thlpp_dry_time.npy',thlpp_dry_time)
        np.save(sp+'/wfp_moist_time.npy',wfp_moist_time)
        np.save(sp+'/wfp_dry_time.npy',wfp_dry_time)
        np.save(sp+'/qlpp_moist_time.npy',qlpp_moist_time) 
        np.save(sp+'/qlpp_dry_time.npy',qlpp_dry_time)
        np.save(sp+'/qrpp_moist_time.npy',qrpp_moist_time) 
        np.save(sp+'/qrpp_dry_time.npy',qrpp_dry_time)
        
        np.save(sp+'/wthlp_av_time.npy',wthlp_av_time)
        np.save(sp+'/wthlpf_moist_time.npy',wthlpf_moist_time)
        np.save(sp+'/wthlpf_dry_time.npy',wthlpf_dry_time)
        
        np.save(sp+'/wqtp_av_time.npy',wqtp_av_time)
        np.save(sp+'/wqtpf_moist_time.npy',wqtpf_moist_time)
        np.save(sp+'/wqtpf_dry_time.npy',wqtpf_dry_time)
        
        np.save(sp+'/wqlp_av_time.npy',wqlp_av_time)
        np.save(sp+'/wqlpf_moist_time.npy',wqlpf_moist_time)
        np.save(sp+'/wqlpf_dry_time.npy',wqlpf_dry_time)
        np.save(sp+'/wqlpf_l_moist_time.npy',wqlpf_l_moist_time)
        np.save(sp+'/wqlpf_l_dry_time.npy',wqlpf_l_dry_time)
        np.save(sp+'/wqlpf_c_moist_time.npy',wqlpf_c_moist_time)
        np.save(sp+'/wqlpf_c_dry_time.npy',wqlpf_c_dry_time)
        np.save(sp+'/wqlpf_r_moist_time.npy',wqlpf_r_moist_time)
        np.save(sp+'/wqlpf_r_dry_time.npy',wqlpf_r_dry_time)
        
        np.save(sp+'/wthlvp_av_time.npy',wthlvp_av_time)
        np.save(sp+'/wthlvpf_moist_time.npy',wthlvpf_moist_time)
        np.save(sp+'/wthlvpf_dry_time.npy',wthlvpf_dry_time)
        np.save(sp+'/wthlvpf_l_moist_time.npy',wthlvpf_l_moist_time)
        np.save(sp+'/wthlvpf_l_dry_time.npy',wthlvpf_l_dry_time)
        np.save(sp+'/wthlvpf_c_moist_time.npy',wthlvpf_c_moist_time)
        np.save(sp+'/wthlvpf_c_dry_time.npy',wthlvpf_c_dry_time)
        np.save(sp+'/wthlvpf_r_moist_time.npy',wthlvpf_r_moist_time)
        np.save(sp+'/wthlvpf_r_dry_time.npy',wthlvpf_r_dry_time)
        np.save(sp+'/wthlvpp_moist_time.npy',wthlvpp_moist_time)
        np.save(sp+'/wthlvpp_dry_time.npy',wthlvpp_dry_time)
